...
<div class="max-w-screen-xl py-2 space-y-12 px-4 lg:space-y-10 lg:py-2 lg:px-6 bg-teal-700 font-[sans-serif] mx-auto">
        <div class="grid md:grid-cols-2 items-center md:gap-10 gap-6">
          ...
          <div class="md:h-[400px] p-2">
            <img src="heroebook.png" class="w-full h-full object-contain rounded-lg" alt="Perpusatakaan Digital" />
          </div>
        </div>
      ...
      <section class="py-8 px-8">
        <!-- Judul Section -->
        <div class="max-w-screen-xl py-4 space-y-10 mx-auto px-4 lg:space-y-6 lg:py-5 lg:px-6">
        <div class="lg:space-y-4">
          <h2 class="ml-2 text-xl font-bold text-gray-900">NEUROLOGI</h2>
          <p class="ml-2 text-base font-medium text-gray-700 my-2">Temukan Ebook tentang Neurologi</p>
        </div>
